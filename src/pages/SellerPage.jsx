        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-slate-600">Phone: {phoneNumber}</p>
            </div>
            <button
              onClick={() => {
                setView('form');
          ...
          {listings.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
              ...
              <h2 className="text-2xl font-semibold text-slate-900 mb-2">No Listings Found</h2>
                ...
                <div key={listing._id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all">
                  ...
                  <div className="p-6">
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-xl font-bold text-slate-900">{listing.propertyType}</h3>
                      {listing.price && (
                    ...
                    <p className="text-slate-600 mb-4">{listing.landAddress}, {listing.city}</p>
                    <div className="grid grid-cols-2 gap-2 text-sm mb-4">
                      {listing.landArea && (
                        <div>
                          <span className="text-emerald-600">Area:</span>
                          <span className="text-slate-900 font-semibold ml-2">{listing.landArea} sq ft</span>
                        </div>
                      )}
                      {listing.landAge !== undefined && (
                        <div>
                          <span className="text-emerald-600">Age:</span>
                          <span className="text-slate-900 font-semibold ml-2">{listing.landAge} years</span>
                        </div>
                      )}
                    </div>
                    <div className="pt-4 border-t border-slate-200">
                      <p className="text-emerald-600 text-sm">Seller: {listing.sellerName}</p>
                      <p className="text-emerald-600 text-sm">Phone: {listing.phoneNumber}</p>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-2xl p-8 mb-6">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-slate-900 mb-2">View Your Listings</h2>
            <p className="text-slate-600">Enter your phone number to view your listed properties</p>
          </div>
          <div className="flex gap-4">
            ...
            <button
              ...
              disabled={loading}
              className="bg-emerald-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-slate-700 transition-all disabled:opacity-50"
            >
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600">Fill in the details to list your property for sale</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="border-b border-slate-200 pb-6">
              <h2 className="text-2xl font-semibold text-slate-800 mb-4">Seller Information</h2>
            ...
            {/* Property Address */}
            <div className="border-b border-slate-200 pb-6">
              <h2 className="text-2xl font-semibold text-slate-800 mb-4">Property Address</h2>
            ...
            {/* Property Details */}
            <div className="border-b border-slate-200 pb-6">
              <h2 className="text-2xl font-semibold text-slate-800 mb-4">Property Details</h2>
